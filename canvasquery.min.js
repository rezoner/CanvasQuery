...
a[2],0,1),e=d.hslToRgb(e,j,f),c[g+0]=e[0],c[g+1]=e[1],c[g+2]=e[2];this.context.putImageData(b,0,0);return this},convolute:function(a,b,c){"undefined"===typeof c&&(c=1);"undefined"===typeof b&&(b=1);for(var e=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),h=Math.sqrt(a.length)+0.5|0,f=h/2|0,g=e.data,k=e.width,e=e.height,l=d.createImageData(this.canvas.width,this.canvas.height),m=l.data,n=1;n<e-1;n++)for(var p=1;p<k-1;p++){for(var q=4*(n*k+p),v=0,w=0,x=0,t=0;t<h;t++)for(var u=0;u<
