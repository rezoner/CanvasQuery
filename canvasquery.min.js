...
c=this.context.webkitImageSmoothingEnabled;this.context.mozImageSmoothingEnabled=!1;this.context.webkitImageSmoothingEnabled=!1;a=this.canvas.width/(a||4)/this.canvas.width;var e=cq(this.canvas.width,this.canvas.height);e.drawImage(this.canvas,0,0,this.canvas.width,this.canvas.height,0,0,this.canvas.width*a|0,this.canvas.height*a|0);this.clear().drawImage(e.canvas,0,0,this.canvas.width*a|0,this.canvas.height*a|0,0,0,this.canvas.width,this.canvas.height);this.context.mozImageSmoothingEnabled=b;this.context.webkitImageSmoothingEnabled=
c;return this},colorToMask:function(a){a=d.color(a).toArray();for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data,c=[],e=0,j=b.length;e<j;e+=4)b[e+0]==a[0]&&b[e+1]==a[1]&&b[e+2]==a[2]?c.push(!1):c.push(!0);return c},grayscaleToMask:function(a){d.color(a).toArray();a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(var b=[],c=0,e=a.length;c<e;c+=4)b.push((a[c+0]+a[c+1]+a[c+2])/3|0);return b},applyMask:function(a){for(var b=this.context.getImageData(0,
0,this.canvas.width,this.canvas.height),c=b.data,e="boolean"===typeof a[0]?"bool":"byte",d=0,f=c.length;d<f;d+=4){var g=a[d/4];c[d+3]="boolean"===e?255*g|0:g|0}this.context.putImageData(b,0,0);return this},fillMask:function(a){var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,e="boolean"===typeof a[0]?"bool":"byte",j=2===arguments.length?"normal":"gradient",f=d.color(arguments[1]);"gradient"===j&&(colorB=d.color(arguments[2]));for(var g=0,h=c.length;g<h;g+=4){var l=
a[g/4];"byte"===e&&(l/=255);"normal"===j?l&&(c[g+0]=f[0]*l|0,c[g+1]=f[1]*l|0,c[g+2]=f[2]*l|0,c[g+3]=255*l|0):(c[g+0]=f[0]+(colorB[0]-f[0])*l|0,c[g+1]=f[1]+(colorB[1]-f[1])*l|0,c[g+2]=f[2]+(colorB[2]-f[2])*l|0,c[g+3]=255)}this.context.putImageData(b,0,0);return this},clear:function(a){a?(this.context.fillStyle=a,this.context.fillRect(0,0,this.canvas.width,this.canvas.height)):this.context.clearRect(0,0,this.canvas.width,this.canvas.height);return this},clone:function(){var a=d.createCanvas(this.canvas.width,
this.canvas.height);a.getContext("2d").drawImage(this.canvas,0,0);return d(a)},fillStyle:function(a){this.context.fillStyle=a;return this},strokeStyle:function(a){this.context.strokeStyle=a;return this},setHsl:function(){var a=1===arguments.length?arguments[0]:arguments,b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,e,j,f;f=[];e=[];for(var g=0,h=c.length;g<h;g+=4)f=d.rgbToHsl(c[g+0],c[g+1],c[g+2]),e=null===a[0]?f[0]:d.limitValue(a[0],0,1),j=null===a[1]?f[1]:d.limitValue(a[1],
0,1),f=null===a[2]?f[2]:d.limitValue(a[2],0,1),e=d.hslToRgb(e,j,f),c[g+0]=e[0],c[g+1]=e[1],c[g+2]=e[2];this.context.putImageData(b,0,0);return this},shiftHsl:function(){var a=1===arguments.length?arguments[0]:arguments,b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,e,j,f;f=[];e=[];for(var g=0,h=c.length;g<h;g+=4)f=d.rgbToHsl(c[g+0],c[g+1],c[g+2]),e=null===a[0]?f[0]:d.wrapValue(f[0]+a[0],0,1),j=null===a[1]?f[1]:d.limitValue(f[1]+a[1],0,1),f=null===a[2]?f[2]:d.limitValue(f[2]+
a[2],0,1),e=d.hslToRgb(e,j,f),c[g+0]=e[0],c[g+1]=e[1],c[g+2]=e[2];this.context.putImageData(b,0,0);return this},convolute:function(a,b,c){"undefined"===typeof c&&(c=1);"undefined"===typeof b&&(b=1);for(var e=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),j=Math.sqrt(a.length)+0.5|0,f=j/2|0,g=e.data,h=e.width,e=e.height,l=d.createImageData(this.canvas.width,this.canvas.height),m=l.data,n=1;n<e-1;n++)for(var p=1;p<h-1;p++){for(var q=4*(n*h+p),v=0,w=0,x=0,t=0;t<j;t++)for(var u=0;u<
j;u++){var r=n+t-f,s=p+u-f;0<=r&&(r<e&&0<=s&&s<h)&&(r=4*(r*h+s),s=a[t*j+u]/c,v+=g[r+0]*s,w+=g[r+1]*s,x+=g[r+2]*s)}m[q+0]=d.mix(g[q+0],v,b);m[q+1]=d.mix(g[q+1],w,b);m[q+2]=d.mix(g[q+2],x,b);m[q+3]=g[q+3]}this.context.putImageData(l,0,0);return this},blur:function(a){return this.convolute([1,1,1,1,1,1,1,1,1],a,9)},gaussianBlur:function(a){return this.convolute([6.7E-7,2.292E-5,1.9117E-4,3.8771E-4,1.9117E-4,2.292E-5,6.7E-7,2.292E-5,7.8633E-4,0.00655965,0.01330373,0.00655965,7.8633E-4,2.292E-5,1.9117E-4,
...
this.canvas.height),c=b.data,e,d,f,g=0;g<c.length;g+=4)e=c[g],d=c[g+1],f=c[g+2],c[g]=c[g+1]=c[g+2]=0.2126*e+0.7152*d+0.0722*f>=a?255:0;this.context.putImageData(b,0,0);return this},sepia:function(){for(var a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),b=a.data,c=0;c<b.length;c+=4)b[c+0]=d.limitValue(0.393*b[c+0]+0.769*b[c+1]+0.189*b[c+2],0,255),b[c+1]=d.limitValue(0.349*b[c+0]+0.686*b[c+1]+0.168*b[c+2],0,255),b[c+2]=d.limitValue(0.272*b[c+0]+0.534*b[c+1]+0.131*b[c+2],0,255);
...
d.keycodes[b.which];a.call(self,b)});return this},onResize:function(a){var b=this;h.addEventListener("resize",function(){a.call(b,h.innerWidth,h.innerHeight)});a.call(b,h.innerWidth,h.innerHeight);return this},onDropImage:function(a){var b=this;document.addEventListener("drop",function(c){c.stopPropagation();c.preventDefault();c=c.dataTransfer.files[0];if(!/image/i.test(c.type))return!1;var d=new FileReader;d.onload=function(c){var d=new Image;d.onload=function(){a.call(b,this)};d.src=c.target.result};
d.readAsDataURL(c)});document.addEventListener("dragover",function(a){a.preventDefault()});return this}};for(var p="arc arcTo beginPath bezierCurveTo clearRect clip closePath createImageData createLinearGradient createRadialGradient createPattern drawFocusRing drawImage fill fillRect fillText getImageData isPointInPath lineTo measureText moveTo putImageData quadraticCurveTo rect restore rotate save scale setTransform stroke strokeRect strokeText transform translate".split(" "),m=0;m<p.length;m++){var n=
p[m];d.Wrapper.prototype[n]=Function("this.context."+n+".apply(this.context, arguments); return this;")}p="canvas fillStyle font globalAlpha globalCompositeOperation lineCap lineJoin lineWidth miterLimit shadowOffsetX shadowOffsetY shadowBlur shadowColor strokeStyle textAlign textBaseline".split(" ");for(m=0;m<p.length;m++)n=p[m],d.Wrapper.prototype[n]=Function("if(arguments.length) { this.context."+n+" = arguments[0]; return this; } else { return this.context."+n+"; }");d.Color=function(){arguments.length&&
this.parse(arguments)};d.Color.prototype={parse:function(a){if("string"===typeof a[0]){var b=d.hexToRgb(a[0]);this[0]=b[0];this[1]=b[1];this[2]=b[2];this[3]="undefined"===typeof a[1]?1:a[1]}else this[0]=a[0],this[1]=a[1],this[2]=a[2],this[3]="undefined"===typeof a[3]?1:a[3]},toArray:function(){return[this[0],this[1],this[2],this[3]]},toRgb:function(){return"rgb("+this[0]+", "+this[1]+", "+this[2]+")"},toRgba:function(){return"rgb("+this[0]+", "+this[1]+", "+this[2]+", "+this[3]+")"},toHex:function(){return d.rgbToHex(this[0],
this[1],this[2])},toHsl:function(){return d.rgbToHsl(this[0],this[1],this[2])},toHsv:function(){return d.rgbToHsv(this[0],this[1],this[2])}};h.cq=h.CanvasQuery=d;"function"===typeof define&&define.amd&&define([],function(){return d})})(window);