...
*/
<<<<<<< HEAD
(function(j){j.requestAnimationFrame=j.requestAnimationFrame||j.webkitRequestAnimationFrame||j.mozRequestAnimationFrame||j.oRequestAnimationFrame||j.msRequestAnimationFrame||function(a){j.setTimeout(a,1E3/60)};var d=function(a){if(0===arguments.length){var b=d.createCanvas(j.innerWidth,j.innerHeight);j.addEventListener("resize",function(){b.width=j.innerWidth;b.height=j.innerHeight})}else if("string"===typeof a)b=d.createCanvas(document.querySelector(a)[0]);else if("number"===typeof a)b=d.createCanvas(arguments[0],
...
1],g="function"===typeof c,d=0,e=a.length;d<e;d++)if(null===a[d]||b&&a[d][b])g&&c(a[d]),a.splice(d--,1),e--},specialBlendFunctions:["color","value","hue","saturation"],blendFunctions:{normal:function(a,b){return b},overlay:function(a,b){a/=255;b/=255;return Math.min(255,Math.max(0,255*(128>a?2*a*b:1-2*(1-a)*(1-b))|0))},hardLight:function(a,b){return d.blendFunctions.overlay(b,a)},softLight:function(a,b){a/=255;b/=255;return d.limitValue(255*((1-2*b)*a*a+2*b*a),0,255)},dodge:function(a,b){return 256*
...
b){return Math.min(a,b)},lightenOnly:function(a,b){return Math.max(a,b)},color:function(a,b){var c=d.rgbToHsl(a),g=d.rgbToHsl(b);return d.hslToRgb(g[0],g[1],c[2])},hue:function(a,b){var c=d.rgbToHsv(a),g=d.rgbToHsv(b);return g[1]?d.hsvToRgb(g[0],c[1],c[2]):d.hsvToRgb(c[0],c[1],c[2])},value:function(a,b){var c=d.rgbToHsv(a),g=d.rgbToHsv(b);return d.hsvToRgb(c[0],c[1],g[2])},saturation:function(a,b){var c=d.rgbToHsv(a),g=d.rgbToHsv(b);return d.hsvToRgb(c[0],g[1],c[2])}},blend:function(a,b,c,g){"undefined"===
typeof g&&(g=1);a=d(a);b=d(b);var h=b.context,e=a.context.getImageData(0,0,a.canvas.width,a.canvas.height);b=h.getImageData(0,0,b.canvas.width,b.canvas.height);e=e.data;b=b.data;var h=this.createImageData(a.canvas.width,a.canvas.height),f=h.data,n=d.blendFunctions[c];if(-1!==d.specialBlendFunctions.indexOf(c)){c=0;for(var k=e.length;c<k;c+=4){var j=n([e[c+0],e[c+1],e[c+2]],[b[c+0],b[c+1],b[c+2]]);f[c+0]=e[c+0]+(j[0]-e[c+0])*g;f[c+1]=e[c+1]+(j[1]-e[c+1])*g;f[c+2]=e[c+2]+(j[2]-e[c+2])*g;f[c+3]=e[c+
3]}}else{c=0;for(k=e.length;c<k;c+=4){var j=n(e[c+0],b[c+0]),l=n(e[c+1],b[c+1]),m=n(e[c+2],b[c+2]);f[c+0]=e[c+0]+(j-e[c+0])*g;f[c+1]=e[c+1]+(l-e[c+1])*g;f[c+2]=e[c+2]+(m-e[c+2])*g;f[c+3]=e[c+3]}}a.context.putImageData(h,0,0);return a},wrapValue:function(a,b,c){a<b?a=c+(a-b):a>c&&(a=b+(a-c));return a},limitValue:function(a,b,c){return a<b?b:a>c?c:a},mix:function(a,b,c){return a+(b-a)*c},hexToRgb:function(a){return["0x"+a[1]+a[2]|0,"0x"+a[3]+a[4]|0,"0x"+a[5]+a[6]|0]},rgbToHex:function(a,b,c){return"#"+
(16777216+(a<<16)+(b<<8)+c).toString(16).slice(1,7)},rgbToHsl:function(a,b,c){a instanceof Array&&(c=a[2],b=a[1],a=a[0]);a/=255;b/=255;c/=255;var g=Math.max(a,b,c),d=Math.min(a,b,c),e,f=(g+d)/2;if(g==d)e=d=0;else{var n=g-d,d=0.5<f?n/(2-g-d):n/(g+d);switch(g){case a:e=(b-c)/n+(b<c?6:0);break;case b:e=(c-a)/n+2;break;case c:e=(a-b)/n+4}e/=6}return[e,d,f]},hslToRgb:function(a,b,c){if(0==b)c=b=a=c;else{var g=function(a,c,b){0>b&&(b+=1);1<b&&(b-=1);return b<1/6?a+6*(c-a)*b:0.5>b?c:b<2/3?a+6*(c-a)*(2/3-
b):a},d=0.5>c?c*(1+b):c+b-c*b,e=2*c-d;c=g(e,d,a+1/3);b=g(e,d,a);a=g(e,d,a-1/3)}return[255*c|0,255*b|0,255*a|0]},rgbToHsv:function(a,b,c){a instanceof Array&&(c=a[2],b=a[1],a=a[0]);a/=255;b/=255;c/=255;var d=Math.max(a,b,c),h=Math.min(a,b,c),e,f=d-h;if(d==h)e=0;else{switch(d){case a:e=(b-c)/f+(b<c?6:0);break;case b:e=(c-a)/f+2;break;case c:e=(a-b)/f+4}e/=6}return[e,0==d?0:f/d,d]},hsvToRgb:function(a,b,c){var d,h,e,f=Math.floor(6*a),j=6*a-f;a=c*(1-b);var k=c*(1-j*b);b=c*(1-(1-j)*b);switch(f%6){case 0:d=
c;h=b;e=a;break;case 1:d=k;h=c;e=a;break;case 2:d=a;h=c;e=b;break;case 3:d=a;h=k;e=c;break;case 4:d=b;h=a;e=c;break;case 5:d=c,h=a,e=k}return[255*d,255*h,255*e]},color:function(){var a=new d.Color;a.parse(arguments);return a},createCanvas:function(a,b){var c=document.createElement("Canvas");a instanceof Image?(c.width=a.width,c.height=a.height,c.getContext("2d").drawImage(a,0,0)):(c.width=a,c.height=b);return c},createImageData:function(a,b){return document.createElement("Canvas").getContext("2d").createImageData(a,
b)}});d.Wrapper=function(a){this.context=a.getContext("2d");this.canvas=a};d.Wrapper.prototype={appendTo:function(a){("object"===typeof a?a:document.querySelector(a)).appendChild(this.canvas);return this},blendOn:function(a,b,c){d.blend(a,this,b,c);return this},blend:function(a,b,c){if("string"===typeof a){var g=a;a=d(d.createCanvas(this.canvas.width,this.canvas.height));a.fillStyle(g).fillRect(0,0,this.canvas.width,this.canvas.height)}d.blend(this,a,b,c);return this},crop:function(a,b,c,d){this.context.drawImage(this.canvas,
a,b,c,d,0,0,c,d);this.canvas.width=c;this.canvas.height=d;return this},colorToMask:function(a){a=d.color(a).toArray();for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data,c=[],g=0,h=b.length;g<h;g+=4)b[g+0]==a[0]&&b[g+1]==a[1]&&b[g+2]==a[2]?c.push(!1):c.push(!0);return c},grayscaleToMask:function(a){d.color(a).toArray();a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(var b=[],c=0,g=a.length;c<g;c+=4)b.push((a[c+0]+a[c+1]+a[c+2])/3|0);return b},
applyMask:function(a){for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,d="boolean"===typeof a[0]?"bool":"byte",h=0,e=c.length;h<e;h+=4){var f=a[h/4];c[h+3]="boolean"===d?255*f|0:f|0}this.context.putImageData(b,0,0);return this},fillMask:function(a){var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,g="boolean"===typeof a[0]?"bool":"byte",h=2===arguments.length?"normal":"gradient",e=d.color(arguments[1]);"gradient"===h&&(colorB=
d.color(arguments[2]));for(var f=0,j=c.length;f<j;f+=4){var k=a[f/4];"byte"===g&&(k/=255);"normal"===h?k&&(c[f+0]=e[0]*k|0,c[f+1]=e[1]*k|0,c[f+2]=e[2]*k|0,c[f+3]=255*k|0):(c[f+0]=e[0]+(colorB[0]-e[0])*k|0,c[f+1]=e[1]+(colorB[1]-e[1])*k|0,c[f+2]=e[2]+(colorB[2]-e[2])*k|0,c[f+3]=255)}this.context.putImageData(b,0,0);return this},clear:function(a){a?(this.context.fillStyle=a,this.context.fillRect(0,0,this.canvas.width,this.canvas.height)):this.context.clearRect(0,0,this.canvas.width,this.canvas.height);
return this},clone:function(){var a=d.createCanvas(this.canvas.width,this.canvas.height);a.getContext("2d").drawImage(this.canvas,0,0);return d(a)},fillStyle:function(a){this.context.fillStyle=a;return this},strokeStyle:function(a){this.context.strokeStyle=a;return this},setHsl:function(){var a=1===arguments.length?arguments[0]:arguments,b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,g,h,e;e=[];g=[];for(var f=0,j=c.length;f<j;f+=4)e=d.rgbToHsl(c[f+0],c[f+1],c[f+2]),
g=null===a[0]?e[0]:d.limitValue(a[0],0,1),h=null===a[1]?e[1]:d.limitValue(a[1],0,1),e=null===a[2]?e[2]:d.limitValue(a[2],0,1),g=d.hslToRgb(g,h,e),c[f+0]=g[0],c[f+1]=g[1],c[f+2]=g[2];this.context.putImageData(b,0,0);return this},shiftHsl:function(){var a=1===arguments.length?arguments[0]:arguments,b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,g,h,e;e=[];g=[];for(var f=0,j=c.length;f<j;f+=4)e=d.rgbToHsl(c[f+0],c[f+1],c[f+2]),g=null===a[0]?e[0]:d.wrapValue(e[0]+a[0],
0,1),h=null===a[1]?e[1]:d.limitValue(e[1]+a[1],0,1),e=null===a[2]?e[2]:d.limitValue(e[2]+a[2],0,1),g=d.hslToRgb(g,h,e),c[f+0]=g[0],c[f+1]=g[1],c[f+2]=g[2];this.context.putImageData(b,0,0);return this},convolute:function(a,b,c){"undefined"===typeof c&&(c=1);"undefined"===typeof b&&(b=1);for(var g=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),h=Math.sqrt(a.length)+0.5|0,e=h/2|0,f=g.data,j=g.width,g=g.height,k=d.createImageData(this.canvas.width,this.canvas.height),l=k.data,m=1;m<
g-1;m++)for(var p=1;p<j-1;p++){for(var q=4*(m*j+p),v=0,w=0,x=0,t=0;t<h;t++)for(var u=0;u<h;u++){var r=m+t-e,s=p+u-e;0<=r&&(r<g&&0<=s&&s<j)&&(r=4*(r*j+s),s=a[t*h+u]/c,v+=f[r+0]*s,w+=f[r+1]*s,x+=f[r+2]*s)}l[q+0]=d.mix(f[q+0],v,b);l[q+1]=d.mix(f[q+1],w,b);l[q+2]=d.mix(f[q+2],x,b);l[q+3]=f[q+3]}this.context.putImageData(k,0,0);return this},blur:function(a){return this.convolute([1,1,1,1,1,1,1,1,1],a,9)},gaussianBlur:function(a){return this.convolute([6.7E-7,2.292E-5,1.9117E-4,3.8771E-4,1.9117E-4,2.292E-5,
6.7E-7,2.292E-5,7.8633E-4,0.00655965,0.01330373,0.00655965,7.8633E-4,2.292E-5,1.9117E-4,0.00655965,0.05472157,0.11098164,0.05472157,0.00655965,1.9117E-4,3.8771E-4,0.01330373,0.11098164,0.22508352,0.11098164,0.01330373,3.8771E-4,1.9117E-4,0.00655965,0.05472157,0.11098164,0.05472157,0.00655965,1.9117E-4,2.292E-5,7.8633E-4,0.00655965,0.01330373,0.00655965,7.8633E-4,2.292E-5,6.7E-7,2.292E-5,1.9117E-4,3.8771E-4,1.9117E-4,2.292E-5,6.7E-7],a,9)},sharpen:function(a){return this.convolute([0,-1,0,-1,5,-1,
0,-1,0],a)},threshold:function(a){for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,d,h,e,f=0;f<c.length;f+=4)d=c[f],h=c[f+1],e=c[f+2],c[f]=c[f+1]=c[f+2]=0.2126*d+0.7152*h+0.0722*e>=a?255:0;this.context.putImageData(b,0,0);return this},sepia:function(){for(var a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),b=a.data,c=0;c<b.length;c+=4)b[c+0]=d.limitValue(0.393*b[c+0]+0.769*b[c+1]+0.189*b[c+2],0,255),b[c+1]=d.limitValue(0.349*b[c+0]+0.686*
b[c+1]+0.168*b[c+2],0,255),b[c+2]=d.limitValue(0.272*b[c+0]+0.534*b[c+1]+0.131*b[c+2],0,255);this.context.putImageData(a,0,0);return this},onStep:function(a,b){var c=this,d=Date.now();this.timer=setInterval(function(){var b=Date.now()-d;a.call(c,b);d=Date.now()},b);return this},onRender:function(a){function b(){requestAnimationFrame(b);a.call(c)}var c=this;requestAnimationFrame(b);return this},onMouseMove:function(a){var b=this;this.canvas.addEventListener("mousemove",function(c){a.call(b,c.layerX,
c.layerY)});return this},onMouseDown:function(a){var b=this;this.canvas.addEventListener("mousemove",function(c){a.call(b,c.layerX,c.layerY,c.button)});return this},onMouseUp:function(a){var b=this;this.canvas.addEventListener("mousemove",function(c){a.call(b,c.layerX,c.layerY,c.button)});return this},onKeyDown:function(a){document.addEventListener("keydown",function(b){b=48<=b.which&&90>=b.which?String.fromCharCode(b.which).toLowerCase():d.keycodes[b.which];a.call(self,b)});return this},onKeyUp:function(a){document.addEventListener("keyup",
function(b){b=48<=b.which&&90>=b.which?String.fromCharCode(b.which).toLowerCase():d.keycodes[b.which];a.call(self,b)});return this},onResize:function(a){var b=this;j.addEventListener("resize",function(){a.call(b,j.innerWidth,j.innerHeight)});a.call(b,j.innerWidth,j.innerHeight);return this}};for(var p="arc arcTo beginPath bezierCurveTo clearRect clip closePath createImageData createLinearGradient createRadialGradient createPattern drawFocusRing drawImage fill fillRect fillText getImageData isPointInPath lineTo measureText moveTo putImageData quadraticCurveTo rect restore rotate save scale setTransform stroke strokeRect strokeText transform translate".split(" "),
l=0;l<p.length;l++){var m=p[l];d.Wrapper.prototype[m]=Function("this.context."+m+".apply(this.context, arguments); return this;")}p="canvas fillStyle font globalAlpha globalCompositeOperation lineCap lineJoin lineWidth miterLimit shadowOffsetX shadowOffsetY shadowBlur shadowColor strokeStyle textAlign textBaseline".split(" ");for(l=0;l<p.length;l++)m=p[l],d.Wrapper.prototype[m]=Function("if(arguments.length) { this.context."+m+" = arguments[0]; return this; } else { return this.context."+m+"; }");
...
", "+this[3]+")"},toHex:function(){return d.rgbToHex(this[0],this[1],this[2])},toHsl:function(){return d.rgbToHsl(this[0],this[1],this[2])},toHsv:function(){return d.rgbToHsv(this[0],this[1],this[2])}};j.cq=j.CanvasQuery=d;"function"===typeof define&&define.amd&&define([],function(){return d})})(window);
=======
