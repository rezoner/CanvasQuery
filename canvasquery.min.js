...
a,b,c,d,0,0,c,d);this.canvas.width=c;this.canvas.height=d;return this},resize:function(a,b){var c=d(a,b).drawImage(this.canvas,0,0,this.canvas.width,this.canvas.height,0,0,a,b);this.canvas=c.canvas;this.context=c.context;return this},matchPalette:function(a){for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=0;c<b.data.length;c+=4){for(var d=[],j=0;j<a.length;j++){var e=cq.hexToRgb(a[j]),g=Math.abs(b.data[c]-e[0]),h=Math.abs(b.data[c+1]-e[1]),e=Math.abs(b.data[c+2]-e[2]);
d.push(g+h+e)}for(j=g=0;j<a.length;j++)d[j]<d[g]&&(g=j);d=cq.hexToRgb(a[g]);b.data[c]=d[0];b.data[c+1]=d[1];b.data[c+2]=d[2]}this.context.putImageData(b,0,0);return this},getPalette:function(){for(var a=[],b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data,c=0,f=b.length;c<f;c+=4)if(b[c+3]){var j=d.rgbToHex(b[c+0],b[c+1],b[c+2]);-1===a.indexOf(j)&&a.push(j)}return a},pixelize:function(a){if(!a)return this;var b=this.context.mozImageSmoothingEnabled,c=this.context.webkitImageSmoothingEnabled;
this.context.mozImageSmoothingEnabled=!1;this.context.webkitImageSmoothingEnabled=!1;a=this.canvas.width/(a||4)/this.canvas.width;this.drawImage(this.canvas,0,0,this.canvas.width,this.canvas.height,0,0,this.canvas.width*a|0,this.canvas.height*a|0);this.drawImage(this.canvas,0,0,this.canvas.width*a|0,this.canvas.height*a|0,0,0,this.canvas.width,this.canvas.height);this.context.mozImageSmoothingEnabled=b;this.context.webkitImageSmoothingEnabled=c;return this},colorToMask:function(a){a=d.color(a).toArray();
for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data,c=[],f=0,j=b.length;f<j;f+=4)b[f+0]==a[0]&&b[f+1]==a[1]&&b[f+2]==a[2]?c.push(!1):c.push(!0);return c},grayscaleToMask:function(a){d.color(a).toArray();a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(var b=[],c=0,f=a.length;c<f;c+=4)b.push((a[c+0]+a[c+1]+a[c+2])/3|0);return b},applyMask:function(a){for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,d=
"boolean"===typeof a[0]?"bool":"byte",j=0,e=c.length;j<e;j+=4){var g=a[j/4];c[j+3]="boolean"===d?255*g|0:g|0}this.context.putImageData(b,0,0);return this},fillMask:function(a){var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,f="boolean"===typeof a[0]?"bool":"byte",j=2===arguments.length?"normal":"gradient",e=d.color(arguments[1]);"gradient"===j&&(colorB=d.color(arguments[2]));for(var g=0,h=c.length;g<h;g+=4){var k=a[g/4];"byte"===f&&(k/=255);"normal"===j?k&&(c[g+
0]=e[0]*k|0,c[g+1]=e[1]*k|0,c[g+2]=e[2]*k|0,c[g+3]=255*k|0):(c[g+0]=e[0]+(colorB[0]-e[0])*k|0,c[g+1]=e[1]+(colorB[1]-e[1])*k|0,c[g+2]=e[2]+(colorB[2]-e[2])*k|0,c[g+3]=255)}this.context.putImageData(b,0,0);return this},clear:function(a){a?(this.context.fillStyle=a,this.context.fillRect(0,0,this.canvas.width,this.canvas.height)):this.context.clearRect(0,0,this.canvas.width,this.canvas.height);return this},clone:function(){var a=d.createCanvas(this.canvas.width,this.canvas.height);a.getContext("2d").drawImage(this.canvas,
0,0);return d(a)},fillStyle:function(a){this.context.fillStyle=a;return this},strokeStyle:function(a){this.context.strokeStyle=a;return this},setHsl:function(){var a=1===arguments.length?arguments[0]:arguments,b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,f,j,e;e=[];f=[];for(var g=0,h=c.length;g<h;g+=4)e=d.rgbToHsl(c[g+0],c[g+1],c[g+2]),f=null===a[0]?e[0]:d.limitValue(a[0],0,1),j=null===a[1]?e[1]:d.limitValue(a[1],0,1),e=null===a[2]?e[2]:d.limitValue(a[2],0,1),f=d.hslToRgb(f,
j,e),c[g+0]=f[0],c[g+1]=f[1],c[g+2]=f[2];this.context.putImageData(b,0,0);return this},shiftHsl:function(){var a=1===arguments.length?arguments[0]:arguments,b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,f,j,e;e=[];f=[];for(var g=0,h=c.length;g<h;g+=4)e=d.rgbToHsl(c[g+0],c[g+1],c[g+2]),f=null===a[0]?e[0]:d.wrapValue(e[0]+a[0],0,1),j=null===a[1]?e[1]:d.limitValue(e[1]+a[1],0,1),e=null===a[2]?e[2]:d.limitValue(e[2]+a[2],0,1),f=d.hslToRgb(f,j,e),c[g+0]=f[0],c[g+1]=f[1],
c[g+2]=f[2];this.context.putImageData(b,0,0);return this},convolute:function(a,b,c){"undefined"===typeof c&&(c=1);"undefined"===typeof b&&(b=1);for(var f=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),j=Math.sqrt(a.length)+0.5|0,e=j/2|0,g=f.data,h=f.width,f=f.height,k=d.createImageData(this.canvas.width,this.canvas.height),l=k.data,n=1;n<f-1;n++)for(var p=1;p<h-1;p++){for(var q=4*(n*h+p),v=0,w=0,x=0,t=0;t<j;t++)for(var u=0;u<j;u++){var r=n+t-e,s=p+u-e;0<=r&&(r<f&&0<=s&&s<h)&&
(r=4*(r*h+s),s=a[t*j+u]/c,v+=g[r+0]*s,w+=g[r+1]*s,x+=g[r+2]*s)}l[q+0]=d.mix(g[q+0],v,b);l[q+1]=d.mix(g[q+1],w,b);l[q+2]=d.mix(g[q+2],x,b);l[q+3]=g[q+3]}this.context.putImageData(k,0,0);return this},blur:function(a){return this.convolute([1,1,1,1,1,1,1,1,1],a,9)},gaussianBlur:function(a){return this.convolute([6.7E-7,2.292E-5,1.9117E-4,3.8771E-4,1.9117E-4,2.292E-5,6.7E-7,2.292E-5,7.8633E-4,0.00655965,0.01330373,0.00655965,7.8633E-4,2.292E-5,1.9117E-4,0.00655965,0.05472157,0.11098164,0.05472157,0.00655965,
1.9117E-4,3.8771E-4,0.01330373,0.11098164,0.22508352,0.11098164,0.01330373,3.8771E-4,1.9117E-4,0.00655965,0.05472157,0.11098164,0.05472157,0.00655965,1.9117E-4,2.292E-5,7.8633E-4,0.00655965,0.01330373,0.00655965,7.8633E-4,2.292E-5,6.7E-7,2.292E-5,1.9117E-4,3.8771E-4,1.9117E-4,2.292E-5,6.7E-7],a,1)},sharpen:function(a){return this.convolute([0,-1,0,-1,5,-1,0,-1,0],a)},threshold:function(a){for(var b=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),c=b.data,d,j,e,g=0;g<c.length;g+=
4)d=c[g],j=c[g+1],e=c[g+2],c[g]=c[g+1]=c[g+2]=0.2126*d+0.7152*j+0.0722*e>=a?255:0;this.context.putImageData(b,0,0);return this},sepia:function(){for(var a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height),b=a.data,c=0;c<b.length;c+=4)b[c+0]=d.limitValue(0.393*b[c+0]+0.769*b[c+1]+0.189*b[c+2],0,255),b[c+1]=d.limitValue(0.349*b[c+0]+0.686*b[c+1]+0.168*b[c+2],0,255),b[c+2]=d.limitValue(0.272*b[c+0]+0.534*b[c+1]+0.131*b[c+2],0,255);this.context.putImageData(a,0,0);return this},onStep:function(a,
b){var c=this,d=Date.now();this.timer=setInterval(function(){var b=Date.now()-d;a.call(c,b);d=Date.now()},b);return this},onRender:function(a){function b(){requestAnimationFrame(b);a.call(c)}var c=this;requestAnimationFrame(b);return this},onMouseMove:function(a){var b=this;this.canvas.addEventListener("mousemove",function(c){a.call(b,c.layerX,c.layerY)});return this},onMouseDown:function(a){var b=this;this.canvas.addEventListener("mousemove",function(c){a.call(b,c.layerX,c.layerY,c.button)});return this},
onMouseUp:function(a){var b=this;this.canvas.addEventListener("mousemove",function(c){a.call(b,c.layerX,c.layerY,c.button)});return this},onKeyDown:function(a){document.addEventListener("keydown",function(b){b=48<=b.which&&90>=b.which?String.fromCharCode(b.which).toLowerCase():d.keycodes[b.which];a.call(self,b)});return this},onKeyUp:function(a){document.addEventListener("keyup",function(b){b=48<=b.which&&90>=b.which?String.fromCharCode(b.which).toLowerCase():d.keycodes[b.which];a.call(self,b)});
return this},onResize:function(a){var b=this;h.addEventListener("resize",function(){a.call(b,h.innerWidth,h.innerHeight)});a.call(b,h.innerWidth,h.innerHeight);return this}};for(var p="arc arcTo beginPath bezierCurveTo clearRect clip closePath createImageData createLinearGradient createRadialGradient createPattern drawFocusRing drawImage fill fillRect fillText getImageData isPointInPath lineTo measureText moveTo putImageData quadraticCurveTo rect restore rotate save scale setTransform stroke strokeRect strokeText transform translate".split(" "),
l=0;l<p.length;l++){var n=p[l];d.Wrapper.prototype[n]=Function("this.context."+n+".apply(this.context, arguments); return this;")}p="canvas fillStyle font globalAlpha globalCompositeOperation lineCap lineJoin lineWidth miterLimit shadowOffsetX shadowOffsetY shadowBlur shadowColor strokeStyle textAlign textBaseline".split(" ");for(l=0;l<p.length;l++)n=p[l],d.Wrapper.prototype[n]=Function("if(arguments.length) { this.context."+n+" = arguments[0]; return this; } else { return this.context."+n+"; }");
